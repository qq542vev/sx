...
Describe 'sx_var_bind_is_rw'
    ...
    Context 'when SX_CFG_SKIP_CHK is 1'
        ...
        It 'skips syntax check and performs direct permission check'
            # 妥当な形式で、書き込み可能な変数を確認
            writable="ok"
            When call sx_var_bind_is_rw "writable"
            The status should be success
        End
