...
Describe 'sx_str_isep'
  ...
  Context 'バインド形式で挿入回数を取得する場合'
    It 'res:cnt で結果と回数を取得すること'
      When call sx_str_isep res:cnt "123456" "-" 2
      The status should be success
      The variable res should equal "12-34-56"
    ...
    It ':cnt で回数のみ取得すること'
      When call sx_str_isep :cnt "123456" "-" 2
      The status should be success
      The variable cnt should equal "'2'"
    End

    It 'limit 制限時の回数を取得すること'
      When call sx_str_isep res:cnt "123456" "-" 2 1
      The status should be success
      The variable res should equal "12-3456"
      The variable cnt should equal "'1'"
    End

    It '挿入なしの場合は回数が 0 であること'
      When call sx_str_isep res:cnt "a" "-" 1
      The status should be success
      The variable res should equal "a"
    ...
    It '空文字列の挿入回数を取得すること'
      When call sx_str_isep res:cnt "" "-" 1 "" $((SX_STR_ISEP_PRE | SX_STR_ISEP_POST))
      The status should be success
      The variable res should equal "-"
      The variable cnt should equal "'1'"
    End
