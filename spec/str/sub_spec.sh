...
Describe 'sx_str_sub'
  ...
  Context 'バインド形式で置換回数を取得する場合'
    It 'res:cnt で結果と回数を取得すること'
      When call sx_str_sub res:cnt "hello world" "world" "earth"
      The variable res should equal "hello earth"
      The variable cnt should equal "'1'"
    End

    It 'res:cnt: で結果と回数（生値）を取得すること'
      When call sx_str_sub res:cnt: "a.b.c.d" "." "_" 2
      The variable res should equal "a_b_c.d"
      The variable cnt should equal "2"
    End

    It ':cnt で回数のみ取得すること'
      When call sx_str_sub :cnt "a.b.c.d" "." "_"
    ...
    It '空パターンの挿入回数を取得すること'
      When call sx_str_sub res:cnt "abc" "" "X"
      The variable res should equal "XaXbXcX"
      The variable cnt should equal "'4'"
    End

    It '不一致の場合は回数が 0 であること'
      When call sx_str_sub res:cnt "hello" "foo" "bar"
