...
Describe 'sx_num_int_mul_abs'
  ...
  It '英字を含む場合はエラーになること'
    When call sx_num_int_mul_abs result 123 abc
    The status should equal 64
  End
