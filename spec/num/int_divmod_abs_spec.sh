...
Describe 'sx_num_int_divmod_abs'
  ...
  It '小さな数の除算ができること（あまりあり）'
    When call sx_num_int_divmod_abs q r 100 3
    The status should be success
  ...
  It '被除数が除数より小さい場合の除算ができること'
    When call sx_num_int_divmod_abs q r 5 10
    The status should be success
  ...
  It '被除数と除数が等しい場合の除算ができること'
    When call sx_num_int_divmod_abs q r 42 42
    The status should be success
  ...
  It '被除数が0の場合の除算ができること'
    When call sx_num_int_divmod_abs q r 0 42
    The status should be success
    The variable q should equal "0"
    The variable r should equal "0"
  End
  ...
  It '単精度除数で多倍長整数の除算ができること'
    When call sx_num_int_divmod_abs q r 1000000000000000000 3
    The status should be success
  ...
  It '多精度除数で大きな数の除算ができること'
    When call sx_num_int_divmod_abs q r 98765431209876543120 12345678901234567890
    The status should be success
  ...
  It '多精度除数で余りが出る大きな数の除算ができること'
    When call sx_num_int_divmod_abs q r 12345678901234567890 12345678900000000000
    The status should be success
    The variable q should equal "1"
  ...
  It '一般パス(d=0)の除算ができること'
    When call sx_num_int_divmod_abs q r 192837465564738291019283746 987654321012
    The status should be success
  ...
  It '一般パス(d=1)の除算ができること'
    When call sx_num_int_divmod_abs q r 192837465564738291019283746 98765432101
    The status should be success
  ...
  It '一般パス(d=2)の除算ができること'
    When call sx_num_int_divmod_abs q r 99999999999999999999 4999999999
    The status should be success
  ...
  It '末尾ゼロ分解を経由する除算ができること'
    When call sx_num_int_divmod_abs q r 12345678900000000000123456789 123400000000
    The status should be success
  ...
  It '除数を省略した場合は除数1として扱われること'
    When call sx_num_int_divmod_abs q r 100
    The status should be success
  ...
  It '負数を含む場合はエラー(64)になること'
    When call sx_num_int_divmod_abs q r 100 -5
    The status should equal 64
  End

  It '非数値を含む場合はエラー(64)になること'
    When call sx_num_int_divmod_abs q r 100 abc
    The status should equal 64
  End
End
