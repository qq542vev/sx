...
Describe 'sx_num_int_div_abs'
  ...
  Context '64ビット設定'
    ...
    It '一般パスで小数部を求める除算ができること'
      When call sx_num_int_div_abs d 10 123456789012345678901234567890 1234567890123456789
      The status should be success
  ...
  It 'ゼロ除算でエラー(64)になること'
    When call sx_num_int_div_abs d 2 100 0
    The status should equal 64
  End

  It '結果変数が読み取り専用の場合にエラー(77)になること'
    readonly ro_res_int_div_abs="const"
    When call sx_num_int_div_abs ro_res_int_div_abs 2 100 3
  ...
  It '小数桁数が不適切な場合はエラー(64)になること'
    When call sx_num_int_div_abs d abc 100 3
    The status should equal 64
  End

  It '被除数が負数の場合はエラー(64)になること'
    When call sx_num_int_div_abs d 2 -5 3
    The status should equal 64
  End
  ...
  It '非数値の除数を含む場合はエラー(64)になること'
    When call sx_num_int_div_abs d 2 100 abc
    The status should equal 64
  End
End