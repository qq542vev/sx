...
Describe 'sx_num_int_divmod'
  ...
  It '小さな数の除算ができること（あまりなし）'
    When call sx_num_int_divmod "q:r:" 100 4
  ...
  It '小さな数の除算ができること（あまりあり）'
    When call sx_num_int_divmod "q:r:" 100 3
    The status should be success
  ...
  It '被除数が除数より小さい場合の除算ができること'
    When call sx_num_int_divmod "q:r:" 5 10
    The status should be success
  ...
  It '被除数と除数が等しい場合の除算ができること'
    When call sx_num_int_divmod "q:r:" 42 42
    The status should be success
  ...
  It '被除数が0の場合の除算ができること'
    When call sx_num_int_divmod "q:r:" 0 42
    The status should be success
    The variable q should equal "0"
    The variable r should equal "0"
  End
  ...
  It '正の被除数を負の除数で除算できること'
    When call sx_num_int_divmod "q:r:" 7 -2
    The status should be success
  ...
  It '負の多倍長整数を除算できること'
    When call sx_num_int_divmod "q:r:" -192837465564738291019283746 987654321012
    The status should be success
  ...
  It '被除数が0で負の除数の場合の除算ができること'
    When call sx_num_int_divmod "q:r:" 0 -5
    The status should be success
    The variable q should equal "0"
    The variable r should equal "0"
  End
  ...
  Context '64ビット設定'
    ...
    It '負の多倍長整数を高速パス5で除算できること'
      When call sx_num_int_divmod "q:r:" -123456789012345678901234567890 999999999
      The status should be success
  ...
  It 'ゼロ除算でエラー(64)になること'
    When call sx_num_int_divmod "q:r:" 100 0
  ...
  It '結果変数が読み取り専用の場合にエラー(77)になること'
    ...
    When call sx_num_int_divmod "ro_res_int_divmod:r:" 100 4
  ...
  It '除数を省略した場合は除数1として扱われること'
    When call sx_num_int_divmod "q:r:" 100
    The status should be success
  ...
  It '負の被除数で除数を省略した場合の除算ができること'
    When call sx_num_int_divmod "q:r:" -7
    The status should be success
  ...
  It '非数値を含む場合はエラー(64)になること'
    When call sx_num_int_divmod "q:r:" 100 abc
    The status should equal 64
  End
End