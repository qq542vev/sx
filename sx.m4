...
##   コールバックのシグネチャ: callback 結果変数名 prev next count
		...
		do
			...
			case "${6}" in
				...
				*)
					...
					set -- "${1}" "${2}" "${3}" "${4}" "${5}" "${6}" "${7}${11}${__sx_str_isep_cb_-}" "${8}" "$((0 < ${12-0} ? ${5} : ${9}))" "${10}${11}"
		...
		do
			...
			case "${6}" in
				...
				*)
					...
					set -- "${1}" "${2}" "${3}" "${4}" "${5}" "${6}" "${__sx_str_isep_cb_-}${11}${7}" "${8}" "$((0 < ${12-0} ? ${5} : ${9}))" "${11}${10}"
					unset __sx_str_isep_cb_
					;;
			esac
		done
