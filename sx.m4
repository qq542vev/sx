	...
	if M_NUM_LT([|0|], [|${4}|]); then
		...
		do
			...
			case "${6}" in
				...
				*)
					"${3}" __sx_str_isep_cb_ "${12}" "${10}${12}" "${11}" "$(( ${9} + 1 ))" || set -- "${@}" "${?}"
					set -- "${1}" "${11}" "${3}" "${4}" "$(( 0 < ${13-0} ? 0 : ${5} - 1 ))" "${6}" "${7}${12}${__sx_str_isep_cb_-}" "${8}" "$(( ${9} + 1 ))" "${10}${12}"
		...
		do
			...
			case "${6}" in
				...
				*)
					"${3}" __sx_str_isep_cb_ "${12}" "${11}" "${12}${10}" "$(( ${9} + 1 ))" || set -- "${@}" "${?}"
					set -- "${1}" "${11}" "${3}" "${4}" "$(( 0 < ${13-0} ? 0 : ${5} - 1 ))" "${6}" "${__sx_str_isep_cb_-}${12}${7}" "${8}" "$(( ${9} + 1 ))" "${12}${10}"
					unset __sx_str_isep_cb_
					;;
			esac
		done
