...
__sx_str_isep() {
	# 位置パラメータ構成:
	# ${1}: res, ${2}: str, ${3}: sep/cb, ${4}: int, ${5}: lim, ${6}: cb_flag
	...
	if M_NUM_LT([|0|], [|${4}|]); then
		...
		while M_NUM_BOOL([|${4} < ${#2} && ${9} < ${5}|]); do
			...
			# $2: right_str, $11: chunk
			case "${6}" in
				0) set -- "${1}" "${2}" "${3}" "${4}" "${5}" "${6}" "${7}${11}${3}" "${8}" "${9}" "${10}${11}";;
				*)
					# コールバック置換: left:$10$11, right:$2, count:$9
					"${3}" __sx_str_isep_cb_ "${10}${11}" "${2}" "${9}" || set -- "${@}" "${?}"
					set -- "${1}" "${2}" "${3}" "${4}" "${5}" "${6}" "${7}${11}${__sx_str_isep_cb_-}" "${8}" "$((0 < ${12-0} ? ${5} : ${9}))" "${10}${11}" ${12+"${12}"}
		...
		while M_NUM_BOOL([|${4} < ${#2} && ${9} < ${5}|]); do
			...
			case "${6}" in
				...
				*)
					# コールバック置換: left:$2, right:$11$10, count:$9
					"${3}" __sx_str_isep_cb_ "${2}" "${11}${10}" "${9}" || set -- "${@}" "${?}"
					set -- "${1}" "${2}" "${3}" "${4}" "${5}" "${6}" "${__sx_str_isep_cb_-}${11}${7}" "${8}" "$((0 < ${12-0} ? ${5} : ${9}))" "${11}${10}" ${12+"${12}"}
					unset __sx_str_isep_cb_
					;;
			esac
		done
