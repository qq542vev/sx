...
__sx_str_isep() {
	...
	# ${10}: ctx (既処理部分)
	# --- マッチごとの一時変数 ---
	# ${11}: next_str, ${12}: chunk, ${13}: ctx_updated, ${14}: stat
	...
	if M_NUM_LT([|0|], [|${4}|]); then
		...
		do
			set -- "${@}" "${2#${8}}"
			set -- "${@}" "${2%"${11}"}"
			# $11: next_str, $12: chunk
			case "${6}" in
				0) set -- "${1}" "${11}" "${3}" "${4}" "$(( ${5} - 1 ))" "${6}" "${7}${12}${3}" "${8}" "$(( ${9} + 1 ))" "${10}${12}";;
				*)
					set -- "${@}" "${10}${12}"
					"${3}" __sx_str_isep_cb_ "${4}" "${13}" "${11}" "$(( ${9} + 1 ))" || set -- "${@}" "${?}"
					set -- "${1}" "${11}" "${3}" "${4}" "$(( 0 < ${14-0} ? 0 : ${5} - 1 ))" "${6}" "${7}${12}${__sx_str_isep_cb_-}" "${8}" "$(( ${9} + 1 ))" "${13}"
		...
		do
			set -- "${@}" "${2%${8}}"
			set -- "${@}" "${2#${11}}"
			# $11: prev_str, $12: chunk
			case "${6}" in
				0) set -- "${1}" "${11}" "${3}" "${4}" "$(( ${5} - 1 ))" "${6}" "${3}${12}${7}" "${8}" "$(( ${9} + 1 ))" "${12}${10}";;
				*)
					set -- "${@}" "${12}${10}"
					"${3}" __sx_str_isep_cb_ "${__sx_str_isep_orig_int_}" "${11}" "${13}" "$(( ${9} + 1 ))" || set -- "${@}" "${?}"
					set -- "${1}" "${11}" "${3}" "${4}" "$(( 0 < ${14-0} ? 0 : ${5} - 1 ))" "${6}" "${__sx_str_isep_cb_-}${12}${7}" "${8}" "$(( ${9} + 1 ))" "${13}"
					unset __sx_str_isep_cb_
					;;
			esac
		done
		unset __sx_str_isep_orig_int_
		set -- "${1}" "" "" "" "" "" "${2}${7}"
	fi
